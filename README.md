...
```javascript
iterDiracComb = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/simulate-iter-dirac-comb@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/simulate-iter-dirac-comb@v0.2.2-umd/browser.js"></script>
```
